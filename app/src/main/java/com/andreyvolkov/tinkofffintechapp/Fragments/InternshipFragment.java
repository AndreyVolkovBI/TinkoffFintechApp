...
public class InternshipFragment extends Fragment {
    ...
    private void init(View view){
        recyclerView = view.findViewById(R.id.fragmentInternshipRecyclerView);
        RecyclerViewInternshipsAdapter adapter = new RecyclerViewInternshipsAdapter(getContext());
