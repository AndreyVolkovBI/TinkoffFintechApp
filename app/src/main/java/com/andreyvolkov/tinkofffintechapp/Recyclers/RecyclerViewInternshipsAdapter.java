...
public class RecyclerViewInternshipsAdapter extends RecyclerView.Adapter<RecyclerViewInternshipsAdapter.ViewHolder>{

    private ArrayList<PostItem> postItems;
    private Context context;

    public RecyclerViewInternshipsAdapter(Context context) {
    ...
    @NonNull
    @Override
    public RecyclerViewInternshipsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerViewInternshipsAdapter.ViewHolder viewHolder, int i) {
